    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
        ...
        <motion.div 
          ...
          className="relative w-full max-w-[95vw] lg:max-w-7xl max-h-[92vh] lg:h-[90vh] bg-white border border-borderLight rounded-2xl sm:rounded-3xl shadow-[0_20px_60px_rgba(168,85,247,0.15)] overflow-y-auto lg:overflow-hidden flex flex-col"
        >
          {/* Close Button */}
          <button 
            onClick={onClose}
          ...
          <div className="flex-1 flex flex-col lg:flex-row min-h-0">
            ...
            <div className="w-full lg:w-5/12 p-5 sm:p-6 lg:p-8 flex flex-col relative z-10 border-b lg:border-b-0 lg:border-r border-borderLight overflow-y-auto">
              ...
              <div className="mb-6 sm:mb-8 pr-8 lg:pr-0">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purpleAccent tracking-tight">
                  Traditional Keyboard
                </h2>
                <p className="text-mutedText mt-2 sm:mt-4 text-xs sm:text-sm font-medium">A simple alternative way to type and communicate.</p>
              </div>
                  ...
                  {workflow.map((step, idx) => (
                    <React.Fragment key={idx}>
                      <div className="flex items-center gap-1.5 sm:gap-2 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg bg-white border border-borderLight shadow-sm">
                        {React.cloneElement(step.icon, { className: "w-3.5 h-3.5 sm:w-4 sm:h-4 text-purpleAccent" })}
            ...
            <div className="w-full lg:w-7/12 p-5 sm:p-6 lg:p-8 flex flex-col gap-4 bg-gradient-to-b from-surface/50 to-background overflow-y-auto">
              ...
              <div className="min-h-[220px] sm:min-h-[280px] lg:flex-1 relative rounded-2xl sm:rounded-3xl overflow-hidden border border-borderLight shadow-md group bg-white">
                <img 
                  src={morseBasicImg} 
